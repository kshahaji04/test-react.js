...
export const getEmeraldChallan:any = createAsyncThunk("challanEmerald/getChallanEmerald",async(token:any)=>{
...
interface RepoAccessTokenState {
  ...
  export const GetEmeraldChallanScreen = createSlice({
    ...
    extraReducers: (builder) => {
      ...
      builder.addCase(getEmeraldChallan.rejected, (state, action) => {
