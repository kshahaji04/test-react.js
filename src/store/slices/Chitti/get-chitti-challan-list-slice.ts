...
export const getChittiChallan:any = createAsyncThunk("challanChitti/getChallanChitti",async(token:any)=>{
...
interface RepoAccessTokenState {
  ...
  export const GetChittiChallanScreen = createSlice({
    ...
    extraReducers: (builder) => {
      ...
      builder.addCase(getChittiChallan.rejected, (state, action) => {
