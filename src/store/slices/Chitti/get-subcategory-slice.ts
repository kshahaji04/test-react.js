...
export const getSubCategoryList:any = createAsyncThunk("getSubCategoryList/getSubCategoryList",async(token:any)=>{
...
interface RepoGetSubcategoryList {
  ...
  export const GetSubCategoryListScreen = createSlice({
    ...
    extraReducers: (builder) => {
      ...
      builder.addCase(getSubCategoryList.rejected, (state, action) => {
