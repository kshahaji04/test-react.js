...
import { getSpecificClientGroup, get_specific_client_group } from '../../store/slices/Master/get-specific-client-group-slice';
...
const UseGetSpecificClientGroup = () => {
  ...
  useEffect(()=>{
if(clientGroupDataFromStore?.length > 0 && clientGroupDataFromStore !== null ){
