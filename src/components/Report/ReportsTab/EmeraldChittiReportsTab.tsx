                ...
                <div className="d-flex justify-content-center flex-wrap  card-listing-container">
                    {reportlist?.length > 0 &&
                        ...
                        reportlist.map((data: any, index: any) => {
                            ...
                            const linkTo: any = `/report/emeraldchitti/${processedStr}`;
                            ...
                            return (
                                ...
                                >
                                    <NavLink
                                        to={`/report/emeraldchitti/${processedStr}`}
...
export default EmeralChittiReportsTab;
