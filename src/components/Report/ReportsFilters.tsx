...
const ReportsFilters = ({ searchInputValues, handleSearchInput, handleSearchBtn, dropdownData }: any) => {
    const location = useLocation()
    const path = location.pathname.trim().split(' ').slice(-1)[0];
    console.log("path in filters", path, dropdownData)
    const karigarData: any = {
        fieldname: 'karigar_Name',
        fieldtype: 'Link',
        link_data: dropdownData?.length > 0 && dropdownData.map((data: any) => data.karigar_name),
    };
    const categoryData: any = {
        fieldname: 'category',
        fieldtype: 'Link',
        link_data: dropdownData?.length > 0 && dropdownData.map((data: any) => data.category),
    };
    const subCategoryData: any = {
        fieldname: 'sub_category',
        fieldtype: 'Link',
        link_data: dropdownData?.length > 0 && dropdownData.map((data: any) => data.sub_category),
    };
    return (
            ...
            <div className="row justify-content-center mt-2">
                <div className="col-lg-2 col-md-4 col-4">
                    ...
                    <input
                        ...
                        onChange={(e: any) => handleSearchInput(e.target.value, "from_date")}
                    />
                </div>
                <div className="col-lg-2 col-md-4 col-4">
                    ...
                    path?.includes("/purchasereceipt") && (
                        <>
                            <div className="col-lg-2 col-md-4 col-4">
                                ...
                                <AutoCompleteInput
                                    data={karigarData}
                                    handleSearchInput={(value: any) => handleSearchInput(value, "karigar_name")}
                    ...
                    path?.includes("/purchasereceipt") && (
                        <>
                            <div className="col-lg-2 col-md-4 col-4">
                                ...
                                <AutoCompleteInput
                                    data={categoryData}
                                    handleSearchInput={(value: any) => handleSearchInput(value, "category")}
                        ...
                        <>
                            <div className="col-lg-2 col-md-4 col-4">
                                ...
                                <AutoCompleteInput
                                    ...
                                    handleSearchInput={(value: any) => handleSearchInput(value, "sub_category")}
