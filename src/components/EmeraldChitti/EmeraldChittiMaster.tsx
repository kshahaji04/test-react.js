...
const EmeraldChittiMaster = () => {
  ...
  const EmbededTableListingData: any = [
    { No: 1, Sub_category: "20/09/2023", product: "001", Gross_weight: "john", Amount: "draft" },
    { No: 2, Sub_category: "20/09/2023", product: "001", Gross_weight: "john", Amount: "draft" },
    { No: 3, Sub_category: "20/09/2023", product: "001", Gross_weight: "john", Amount: "draft" },
    { No: 4, Sub_category: "20/09/2023", product: "001", Gross_weight: "john", Amount: "draft" },
