...
export const chittiCategoryPartywiseReportApi = async (
  ...
  let url: any =
    '/api/method/challan.sdk.api?version=v1&method=get_category_partywise_report&entity=category_partywise&';
...
export const chittiCategorySummaryReportApi = async (
  ...
  // Construct the URL based on the URL parameters
  let url: any =
    '/api/method/challan.sdk.api?version=v1&method=get_category_summary_report&entity=category_summary&';
  if (urlParams.length > 0) {
    url += `${urlParams.join('&')}`;
  }
...
export const chittiSubcategoryReportApi = async (
  ...
  // Construct the URL based on the URL parameters
  let url: any =
    '/api/method/challan.sdk.api?version=v1&method=get_subcategory_report&entity=subcategory_report&';
  if (urlParams.length > 0) {
    url += `${urlParams.join('&')}`;
  }
